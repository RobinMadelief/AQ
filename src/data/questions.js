...
const PERCEPTION_QUESTIONS = [
  {
    ...
    answers: [
      { text: 'Not always. The more AI does, the less it feels like mine.', archetype: 'skeptic' },
      { text: 'Mostly yes. I set the direction so the output is still mine.', archetype: 'delegator' },
      { text: 'It depends on how much the tool shaped the final result.', archetype: 'experimenter' },
      { text: 'Yes. My thinking drove it, so it is mine.', archetype: 'amplifier' },
      { text: 'I designed how the output would be produced. That makes it mine.', archetype: 'architect' },
    ],
  },
  {
    id: 'l_2',
    ...
    answers: [
      { text: 'No. My best work comes from my own thinking, not tools.', archetype: 'skeptic' },
      { text: 'Yes. AI handles so much that I rely on it constantly.', archetype: 'delegator' },
      { text: 'Somewhat. Though I keep finding new tools that change how I work.', archetype: 'experimenter' },
      { text: 'Yes. AI sharpens my thinking in ways I would miss without it.', archetype: 'amplifier' },
      { text: 'Yes. The systems I have built are part of how I work now.', archetype: 'architect' },
    ],
  },
  {
    id: 'l_3',
    ...
    context: null,
    situation: null,
    question: 'AI has changed what I see as possible.',
    answers: [
      { text: 'Not really. I see the same possibilities. I just have more tools.', archetype: 'skeptic' },
      { text: 'Somewhat. It makes more things achievable in the time I have.', archetype: 'delegator' },
      { text: 'Yes. Every new tool opens up something I had not considered before.', archetype: 'experimenter' },
      { text: 'Yes. I think about problems differently because of how I use AI.', archetype: 'amplifier' },
      { text: 'Yes. I can now build things that were not possible for one person before.', archetype: 'architect' },
    ],
  },
  {
    id: 'l_4',
    ...
    context: null,
    situation: null,
    question: 'I think about AI as infrastructure.',
    answers: [
      { text: 'No. It is a tool I pick up occasionally, nothing more.', archetype: 'skeptic' },
      { text: 'Somewhat. I use it constantly but have not thought much about the structure.', archetype: 'delegator' },
      { text: 'I like the idea but I have not settled on one approach yet.', archetype: 'experimenter' },
      { text: 'Yes. I have a consistent way of integrating it into how I work.', archetype: 'amplifier' },
      { text: 'Yes. I have built systems around it that run without me prompting each time.', archetype: 'architect' },
    ],
  },
  {
    id: 'l_5',
    ...
    context: null,
    situation: null,
    question: 'When you use AI for work or study, do you feel empowered, or like you are cheating?',
    answers: [
      { text: 'Mostly like I am cheating. Doing it myself is what actually means something.', archetype: 'skeptic' },
      { text: 'Empowered. If AI can handle it, that is the whole idea.', archetype: 'delegator' },
      { text: 'A bit of both. It depends on which tool and how I use it.', archetype: 'experimenter' },
      { text: 'Empowered. Knowing how to use AI well is a skill worth owning.', archetype: 'amplifier' },
      { text: 'Empowered. I decided the output, so I am the author.', archetype: 'architect' },
    ],
  },
]
...
const BEHAVIOR_QUESTIONS = [
  ...
  },
  {
    ...
    situation: 'You have an essay assignment on a topic you find interesting. You have enough time to write it well.',
  ...
  },
  {
    ...
    answers: [
      { text: 'I explain that I use it sparingly and only when it helps.', archetype: 'skeptic' },
